  ...
  const services = [
    {
      ...
      price: '₹39/hour',
      image: 'https://placehold.co/400x300?text=Modern+home+interior+cleaning+service+with+professional+cleaner+organizing+living+room',
    ...
    },
    {
      ...
      price: '₹39/hour',
      image: 'https://placehold.co/400x300?text=Modern+office+space+cleaning+service+with+professional+maintaining+workspace+desks',
    ...
    },
    {
      ...
      price: '₹39/hour',
      image: 'https://placehold.co/400x300?text=Large+shopping+mall+interior+cleaning+service+with+team+maintaining+retail+space',
    ...
    },
    {
      ...
      price: '₹39/hour',
      image: 'https://placehold.co/400x300?text=Clean+hospital+corridor+with+medical+cleaning+professional+maintaining+sterile+environment',
    ...
    },
    {
      ...
      price: '₹39/hour',
      image: 'https://placehold.co/400x300?text=Professional+kitchen+with+chef+preparing+healthy+home+cooked+meals+cooking+service',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
                <img 
                  src="https://placehold.co/600x400?text=Professional+cleaning+team+working+in+modern+home+with+cleaning+equipment+and+supplies" 
